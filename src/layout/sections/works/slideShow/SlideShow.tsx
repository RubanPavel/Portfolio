...
const properties = {
  prevArrow: <div className="arrow prev">
          <span className="svg svg-arrow-left">
            <svg fill='#fff'  version="1.1" id="svg4-Layer_1" xmlns="http://www.w3.org/2000/svg"
  ...
  nextArrow:
    <div className="arrow next">
          <span className="svg svg-arrow-right">
            <svg fill='#fff' version="1.1" id="svg5-Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="14px" height="26px"
    ...
    >
      {props.images.map((i, index) => (
        ...
        <div className="slide-box" key={index} >
          <img style={{objectFit: "cover", width: "100%", filter: 'brightness(90%)'}} alt="Slide Image" src={i.img}/>
